...
import UIKit
import FSPagerView
class test2: UIViewController ,FSPagerViewDataSource,FSPagerViewDelegate {
   
    fileprivate let imageNames = ["002","003","004","005","006" ]
    ...
    */
    ...
    extension test2:UICollectionViewDelegate,UICollectionViewDataSource
    {
    ...
    extension test2: UICollectionViewDelegateFlowLayout {
