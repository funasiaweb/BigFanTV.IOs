...
import StoreKit
import MuviSDK
class MoviesdetailsVC1: UIViewController,UIPopoverPresentationControllerDelegate {
...
Common1.Commonapi4(parameters: parameters, urlString: CommonApiEndPoints.GetPpvPlan) { (data, err) -> (Void) in
  ...
  */
    ...
    extension MoviesdetailsVC1:MDCTabBarDelegate
    {
    ...
    extension MoviesdetailsVC1:UICollectionViewDelegate,UICollectionViewDataSource
    {
    ...
    extension MoviesdetailsVC1: UICollectionViewDelegateFlowLayout {
...
extension MoviesdetailsVC1:MuviPlayerPlaybackDelegate
{
