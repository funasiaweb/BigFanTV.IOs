...
import StoreKit
import MuviSDK
class OtherVideosVCDetails: UIViewController,UIPopoverPresentationControllerDelegate {
...
*/
    ...
    extension OtherVideosVCDetails:MDCTabBarDelegate
    {
    ...
    extension OtherVideosVCDetails:UICollectionViewDelegate,UICollectionViewDataSource
    {
    ...
    extension OtherVideosVCDetails: UICollectionViewDelegateFlowLayout {
...
extension OtherVideosVCDetails:MuviPlayerPlaybackDelegate
{
