...
import MuviPlayer
import CoreMedia
class LiveTvDetailsVC: UIViewController,UIPopoverPresentationControllerDelegate {
    ...
    extension LiveTvDetailsVC:MDCTabBarDelegate
    {
    ...
    extension LiveTvDetailsVC:UICollectionViewDelegate,UICollectionViewDataSource
    {
...
extension LiveTvDetailsVC:MuviPlayerPlaybackDelegate
{
