...
import MuviPlayer
import CoreMedia
class SerirsDetailsVC: UIViewController,UIPopoverPresentationControllerDelegate {
           ...
           super.viewDidLoad()
            ...
            Timer.scheduledTimer(withTimeInterval: 0.1, repeats: false) { (t) in
                              if Connectivity.isConnectedToInternet()
                              {
                                ...
                                if self.contenttypesid == "3"
                                 {
                                 self.getEpisodedeatils(permaa:self.perma, offset: self.offset)
                                }else if self.contenttypesid == "1"
                                {
   ...
   extension SerirsDetailsVC:MDCTabBarDelegate
   {
   ...
   extension SerirsDetailsVC:UICollectionViewDelegate,UICollectionViewDataSource
   {
    ...
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath)
    {
       ...
       func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
         ...
         return Actioncell
            } else    if collectionView == CollectionV
           {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
          if collectionView == CollectionV
        {
            ...
            displayVC.imagename = item.poster_url ?? ""
          ...
          {
            let storyBoard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
             let displayVC = storyBoard.instantiateViewController(withIdentifier: "SerirsDetailsVC3") as! SerirsDetailsVC3
                displayVC.modalPresentationStyle = .fullScreen
   ...
   extension SerirsDetailsVC: UICollectionViewDelegateFlowLayout {
...
extension SerirsDetailsVC:MuviPlayerPlaybackDelegate
{
