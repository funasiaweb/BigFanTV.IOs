...
class test5: UIViewController{
        ...
        let sampledata:[sample] = [
         sample(img: "ironman", labletext: "kolhapur"),
         sample(img: "ironman", labletext: "kolhapur"),
         sample(img: "ironman", labletext: "kolhapur"),
         sample(img: "ironman", labletext: "kolhapur"),
         sample(img: "ironman", labletext: "kolhapur"),
    ...
    */
    ...
    extension test5:UICollectionViewDelegate,UICollectionViewDataSource
    {
    ...
    extension test5: UICollectionViewDelegateFlowLayout {
