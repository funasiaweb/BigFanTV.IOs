...
import UIKit
import FSPagerView
class listen1: UIViewController ,FSPagerViewDataSource,FSPagerViewDelegate {

fileprivate let imageNames = ["10","20","30","40" ]
...
func pagerViewWillEndDragging(_ pagerView: FSPagerView, targetIndex: Int) {
    ...
    */
    ...
    extension listen1:UICollectionViewDelegate,UICollectionViewDataSource
    {
    ...
    extension listen1: UICollectionViewDelegateFlowLayout {
