...
class GameVC: UIViewController {
    ...
    lazy var firstController: MainViewController = {
         var viewController = self.storyboard?.instantiateViewController(withIdentifier: "MainViewController") as! MainViewController
