...
import StoreKit
import MuviSDK
class FeaturedHomeDetails1: UIViewController,UIPopoverPresentationControllerDelegate {
   ...
   func buyTheccontents(planId:String,movieid:String)
   {
    ...
    extension FeaturedHomeDetails1:MDCTabBarDelegate
    {
    ...
    extension FeaturedHomeDetails1:UICollectionViewDelegate,UICollectionViewDataSource
    {
...
extension FeaturedHomeDetails1:MuviPlayerPlaybackDelegate
{
