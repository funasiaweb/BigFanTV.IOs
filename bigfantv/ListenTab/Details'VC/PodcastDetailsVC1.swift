...
import MuviPlayer
import CoreMedia
class PodcastDetailsVC1: UIViewController,UIPopoverPresentationControllerDelegate {
    ...
    extension PodcastDetailsVC1:MDCTabBarDelegate
    {
    ...
    extension PodcastDetailsVC1:UICollectionViewDelegate,UICollectionViewDataSource
    {
        ...
        func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
        {
                     let storyBoard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
                      let secondViewController =  storyBoard.instantiateViewController(withIdentifier: "PodcastDetailsVC") as! PodcastDetailsVC
    ...
    extension PodcastDetailsVC1: UICollectionViewDelegateFlowLayout {
...
extension PodcastDetailsVC1:MuviPlayerPlaybackDelegate
{
