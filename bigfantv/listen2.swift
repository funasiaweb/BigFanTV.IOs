...
import UIKit
import FSPagerView
class listen2: UIViewController,FSPagerViewDataSource,FSPagerViewDelegate {

fileprivate let imageNames = ["100","200","300","400" ]
...
func pagerViewWillEndDragging(_ pagerView: FSPagerView, targetIndex: Int) {
    self.pageControl.currentPage = targetIndex
        ...
        let sampledata:[sample] = [
         sample(img: "Radio Mirchi", labletext: "kolhapur"),
         sample(img: "Radio Mirchi", labletext: "kolhapur"),
         sample(img: "Radio Mirchi", labletext: "kolhapur"),
         sample(img: "Radio Mirchi", labletext: "kolhapur"),
         sample(img: "Radio Mirchi", labletext: "kolhapur"),
    ...
    */
    ...
    extension listen2:UICollectionViewDelegate,UICollectionViewDataSource
    {
    ...
    extension listen2: UICollectionViewDelegateFlowLayout {
