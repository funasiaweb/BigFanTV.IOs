//
//  RadioStationVC.swift
//  bigfantv
//
//  Created by Ganesh on 11/07/20.
...
import Alamofire
class RadioStationVC: UIViewController {
    ...
    @IBAction func FinishBttapped(_ sender: MDCButton) {
         self.performSegue(withIdentifier: "totabvc", sender: self)
...
//
   ...
   extension RadioStationVC:UICollectionViewDelegate,UICollectionViewDataSource
   {
...
//https://funasia.net/bigfantv.funasia.net/service/saveFavouriteRadio.html
   ...
   extension RadioStationVC: UICollectionViewDelegateFlowLayout
        {
